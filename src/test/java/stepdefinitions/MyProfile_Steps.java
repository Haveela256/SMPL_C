...
//
//
//  @And("Add the profile details {string} {string} {string} {string} {string} {string} {string}")
//  public void addTheProfileDetails(String FirstName,String MiddleName,String LastName, String Designation,String File, String ReplaceFile, String EmailAddress) throws InterruptedException {
//    myProfilePage.addDetails(FirstName,MiddleName, LastName, Designation, File, ReplaceFile,EmailAddress );
//    }
...
//
//
//  @And("Add profile and Verify crop popup {string} {string}")
//  public void addProfileAndVerifyCropPopup(String File, String ReplaceFile) throws InterruptedException {
//    myProfilePage.profile( File,  ReplaceFile);
//  }
//}
