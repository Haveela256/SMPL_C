...
public class SignUp_steps {
    ...
    public void sendInviteToCustomerAdmin(String Email, String Subscription, String OrderNumber) throws InterruptedException {
        signUpPage.sendInviteFromSuperAdmin(Email,Subscription,OrderNumber);
    }

    @Given("Click on Register button {string}")
    public void click_on_register_button(String Email) throws InterruptedException {
  signUpPage.register(Email);
    }

    @Given("Verify the Sign Up page")
    public void verify_the_sign_up_page() throws InterruptedException {
