Feature: Gap Assessment Chatbot
  ...
  Scenario Outline: Create a assessment through Intent Bot
    ...
    Examples:
      ...
      | "random2.test@yopmail.com" | "Vassar@123" | ""      | "6"             | "New QA assessment" | "Level 1" | "Low impact"       | "6"       | "Access Control,Physical Protection,Situational Awareness,Systems and Communications Protection,Identification and Authentication,Media Protection"                                                                                                                                                               |
      | "random2.test@yopmail.com" | "Vassar@123" | ""      | "1"             | "Assessment"        | "Level 1" | "High Impact"      | "6"       | "Access Control,Physical Protection,Situational Awareness,Systems and Communications Protection,Identification and Authentication,Media Protection"                                                                                                                                                               |
      | "random2.test@yopmail.com" | "Vassar@123" | ""      | "1"             | "GapAsses"          | "Level 1" | "Moderate Impact " | "6"       | "Access Control,Physical Protection,Situational Awareness,Systems and Communications Protection,Identification and Authentication,Media Protection"                                                                                                                                                               |
