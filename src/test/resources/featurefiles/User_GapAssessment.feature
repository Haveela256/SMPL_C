Feature: User Gap Assessment Module
  ...
  Scenario Outline: Validate Gap Assessment Module
    ...
    Examples:
      ...
      | "smpl.user@yopmail.com" | "Vassar@123" | ""      | "Smpl Test"    | "Access Control-24" | "AC.L1-3.1.1" | "Yes,No,Not Sure,Not Applicable,Yes" | "Partially Implemented" | "Risk Accepted" |
      | "smpl.user@yopmail.com" | "Vassar@123" | ""      | "Smpl Test"    | "Access Control-24" | "AC.L1-3.1.2" | "Yes,No,Not Sure,No,Yes"             | "Partially Implemented" | "Risk Accepted" |