Feature: Gap Assessment Module
  ...
  Scenario Outline: Validate Gap Assessment Module
    ...
    Examples:
      ...
      | Example                                        | EmailAddress               | Password     | Toaster | AssessmentName       | CopyName            | RenameAssessment | CopyAssessmentToaster            | ErrorToaster                                                              | RenameSuccessfulToaster           | DeletedFileToaster          | BarsCount | BarsNames                                                                                                                                                                                                                                                                                                        |
      ...
      | rename assessment                              | "random3.test@yopmail.com" | "Vassar@123" | ""      | "Regulations1"       | "CopieddAssessMent" | "Regulations2"   | "Assessment Copied Successfully" | ""                                                                        | "Assessment Renamed Successfully" | "File deleted successfully" | "14"      | "Access Control,Audit and Accountability,Awareness and Training,Configuration Management,Maintenance,Personnel Security,Physical Protection,Risk Mangement,Security Assessment,Situational Awareness,Systems and Communications Protection,Incident Response,Identification and Authentication,Media Protection" |
      | copy an asessment by providing existing name   | "random3.test@yopmail.com" | "Vassar@123" | ""      | "RenamedAssessment9" | "CopiedAssessMent"  | "Regulations3"   | "Assessment Copied Successfully" | "Assessment Name Already Exist Please Choose Another Assessment name !!!" | "Assessment Renamed Successfully" | "File deleted successfully" | "6"       | "Access Control,Physical Protection,Situational Awareness,Systems and Communications Protection,Identification and Authentication,Media Protection"                                                                                                                                                              |
      | rename an asessment by providing existing name | "random3.test@yopmail.com" | "Vassar@123" | ""      | "renametech"         | "Copyied"           | "renametech"     | "Assessment Copied Successfully" | "Assessment Name Already Exist Please Choose Another Assessment name !!!" | ""                                | "File deleted successfully" | "14"      | "Access Control,Audit and Accountability,Awareness and Training,Configuration Management,Maintenance,Personnel Security,Physical Protection,Risk Mangement,Security Assessment,Situational Awareness,Systems and Communications Protection,Incident Response,Identification and Authentication,Media Protection" |
