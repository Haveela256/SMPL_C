Feature: Gap Assessment Module
  ...
  Scenario Outline: Validate Gap Assessment Module
    ...
    Examples:
      ...
      | copy assessment                                | "Vassar.qa@yopmail.com" | "Vassar@123" | ""      | "New QA assessment1" | " Assessment Copied Successfully" | "CopiedAssessMent"   | ""                   | ""                    | ""                                                                        | ""                                  | "File deleted successfully" | "6"       | "Access Control,Physical Protection,Situational Awareness,Systems and Communications Protection,Identification and Authentication,Media Protection" |
      | rename assessment                              | "Vassar.qa@yopmail.com" | "Vassar@123" | ""      | "New QA assessment2" | ""                                | ""                   | "RenamedAssessment"  | ""                    | ""                                                                        | " Assessment Renamed Successfully " | ""                          | ""        | ""                                                                                                                                                  |
      ...
      | rename an asessment by providing existing name | "Vassar.qa@yopmail.com" | "Vassar@123" | ""      | "New QA assessment4" | ""                                | ""                   | "New QA assessment3" | ""                    | "Assessment Name Already Exist Please Choose Another Assessment name !!!" | ""                                  | ""                          | ""        | ""                                                                                                                                                  |
