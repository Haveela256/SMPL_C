...
//    }
//
//    public void regulationtabs(String Cards, String AssessmentName, String Regulationtabs) throws InterruptedException {
//        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(20));
//            String[] regulation = Regulationtabs.split(",");
//            System.out.println(regulation);
//            for (int i = 0; i < regulation.length; i++) {
//                wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//li[@class='nav-item']//following::a[text()='" + regulation + "']")));
//                if (driver.findElement(By.xpath("//li[@class='nav-item']//following::a[text()='" + regulation + "']")).isDisplayed()) {
//                    String tabOne = driver.findElement(firstTab).getText();
//                    System.out.println(tabOne);
//                    Assert.assertEquals(regulation, tabOne);
//                    wait.until(ExpectedConditions.elementToBeClickable(nextIcon));
//                    driver.findElement(nextIcon).click();
//                }
//            }}
...
//        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(20));
//        if (driver.findElement(firstTab).isDisplayed()) {
//            wait.until(ExpectedConditions.elementToBeClickable(previousIcon));
