...
public class AssetInventory_page {
    ...
    public void uploadFile(String AssetFileName, String File) throws InterruptedException {
        ...
        if(driver.findElement(uploadFilePath).isDisplayed()){
            ...
            Thread.sleep(3000);
            driver.findElement(namePath).sendKeys(AssetFileName);
            Thread.sleep(5000);
        ...
        if(uploadedFile.isDisplayed()) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                if (table.equals(addedFile)) {
                    Assert.assertEquals(AssetFileName, addedFile);
                }
...
//        driver.findElement(facilities).click();
    ...
    public void delete(String AssetFileName) throws InterruptedException {
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
        Thread.sleep(3000);
