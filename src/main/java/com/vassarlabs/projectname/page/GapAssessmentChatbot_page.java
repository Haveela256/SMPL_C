...
public class GapAssessmentChatbot_page {
    ...
    private By technicalFootprintHyperlink = By.xpath("//a[text()='Click here to fill your technical footprint']");
...
//            Thread.sleep(1000);
    ...
    public void pagination() {
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
        if(driver.findElement(paginationDropdown).isDisplayed()){
