Feature: Discovery Module Asset Inventory tab
...
#Asset Inventory tab
  Scenario Outline: Upload files on Asset Inventory tab
    ...
    Examples:
      ...
      | "smpl.user@yopmail.com" | "Vassar@123" | ""      | "2"         | "Asset"           | "C:/Users/user/Downloads/MODIFIED.xlsx" | "File uploaded successfully" | "File deleted successfully" |
      | "smpl.user@yopmail.com" | "Vassar@123" | ""      | "2"         | "Inventory"       | "C:/Users/user/Downloads/MODIFIED.xlsx" | "File uploaded successfully" | "File deleted successfully" |
      | "smpl.user@yopmail.com" | "Vassar@123" | ""      | "2"         | "Asset Inventory" | "C:/Users/user/Downloads/MODIFIED.xlsx" | "File uploaded successfully" | "File deleted successfully" |
      | "smpl.user@yopmail.com" | "Vassar@123" | ""      | "2"         | "File"            | "C:/Users/user/Downloads/MODIFIED.xlsx" | "File uploaded successfully" | "File deleted successfully" |
